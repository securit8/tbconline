...
@section('title')
ვიდეო-გალერეა | გალერეის ცვლილება
@endsection
...
<br>
    ...
    {!! Form::open(['action'=>['Admin\VideoController@update',$video->id],'method'=>'post']) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::text($locale.'[name]',$video->{'name:'.$locale},['class'=>'form-control']) !!}
    </div>
    ...
    {!! Form::submit('ჩანაწერის ცვლილება!',['class'=>'btn btn-info','id'=>'submit_btn']) !!}
