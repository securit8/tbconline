...
ჩვენთან ერთად მოიარეთ ჩვენი ქვეყანა, მთა-ბარი, მოიარეთ საქართველო...</p>
        ...
        <h5 class = "mt-5 d-block">2 ღამე რაჭაში</h5>
...
<p>
09:00-გასვლა თბილისიდან ამბროლაურის მიმართულებით. საშუალო მგზავრობის დრო 4 საათი და 30 წუთი.
გზად შაუორის წყალსაცავს და ნიკორწმინდის ტაძარის მონახულება.
</p>
<p>13:00-სადილი ქართულ რესტორანში.</p>
<p>14:00-შაორის წყალსაცავი, გამოყოფილი დრო 30 წუთი.</p>
<p>
14:45-ნიკორწმინდის ტაძარი. გამოყოფილი დრო 30 წუთი.
განთავსება სასტუმროში „სანსეტ შოვი“.
თავისუფალი დრო.
...
<p>
13:00-გამგზავრება ამბროლაურის მიმართულებით. გზად ბარაკონის ტაძრის მონახულება და ფოტო სტოპები.
ამბროლაურში მარანი სად მელში, ღვინის დეგუსტაცია, მასტერკლასები, მცირე ფოლკ შოუ, და სასიამოვნო ვახშამი ულამაზეს ხედებზე.
...
<div class = "col-12 d-flex justify-content-center" style = "border:1px solid black;padding:0;border-radius:20px;margin-bottom:20px;">
  ...
  <div class = "col-2 ticket_padding_top">
    <p style = "font-size:1rem;padding-top:6px;"><span style="color:black;">1320</span>&nbsp;ლარი</p>
  </div>
  <div class = "col-2 ticket_padding_top">
    <button type ="button" class = "btn btn-success">ყიდვა</button>
  </div>
...
<div class = "col-12 d-flex justify-content-center" style = "border:1px solid black;padding:0;border-radius:20px;margin-bottom:20px;">
  ...
  <div class = "col-2 ticket_padding_top">
    <p style = "font-size:1rem;padding-top:6px;"><span style="color:black;">1800</span>&nbsp;ლარი</p>
  </div>
  <div class = "col-2 ticket_padding_top">
    <button type ="button" class = "btn btn-success">ყიდვა</button>
  </div>
